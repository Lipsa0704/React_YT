...
const RightCardContent = (props) => {
  return (
    <div  className='absolute top-0 left-0 h-full w-full p-10 flex flex-col justify-between'>
            ...
            <div>
                <p className='text-lg  font-semibold leading-relaxed text-white mb-10'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Hic, id explicabo aliquid error asperiores autem.</p>
